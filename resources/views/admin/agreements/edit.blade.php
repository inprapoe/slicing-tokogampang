        ...
        <div class="col-lg-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('agreements.update', $agreement->id) }}" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="form-group row">
                            <label class="col-sm-2 col-form-label">Title</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control {{ $errors->has('title') ? ' is-invalid' : '' }}" name="title" value="{{ old('title', $agreement->title) }}">
                                @if($errors->has('title'))
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <select class="form-control {{ $errors->has('pages') ? ' is-invalid' : '' }}" name="pages" id="pages">
                                    <option value="product_owner" {{ old('pages' ,$agreement->pages) == 'product_owner' ? 'selected' : '' }}>Product Owner</option>
                                    <option value="marketer" {{ old('pages' ,$agreement->pages) == 'marketer' ? 'selected' : '' }}>marketer</option>
                                </select>
                                @if($errors->has('pages'))
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <select class="form-control {{ $errors->has('type') ? ' is-invalid' : '' }}" name="type" id="type">
                                    <option value="privacy_policy" {{ old('type',  $agreement->type) == 'policy' ? 'selected' : '' }}>Privacy Policy</option>
                                    <option value="terms_of_service" {{ old('type',  $agreement->type) == 'terms' ? 'selected' : '' }}>Terms Of Service</option>
                                    <option value="mou" {{ old('type',  $agreement->type) == 'mou' ? 'selected' : '' }}>MoU</option>
                                </select>
                                @if($errors->has('type'))
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10 {{ $errors->has('text') ? ' custom-is-invalid' : '' }}">
                                <textarea class="summernote" name="text">{{ old('text', $agreement->text) }}</textarea>
                                @if($errors->has('text'))
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="file" name="attachment" value="{{ old('attachment', $agreement->attachement) }}">
